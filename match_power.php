<!DOCTYPE PHP>
<head>
	<title>Douglas Quinn - Powerball</title>
				...
				<div class="col-12">
					...
					<div class="well">
						<div class="page-header">
							<h1>VA Lottery <small>Powerball</small></h1>
							<h4>This was created in PHP and will generate a VA Lottery, Powerball number.  It will then access a MYSQL database with all the Powerball winning lottery numbers and tell you if the number created has ever won.</h4>
						</div>
						<p class="lead">
							<?php
								$numbers = array();
								...
								$text = $text.$lotto;
								$sql = "SELECT date_hit FROM lottery_power WHERE power LIKE '$lotto' AND ball LIKE '$ball'";
								$text = $text."   Powerball: ".$ball;
								echo $text;
