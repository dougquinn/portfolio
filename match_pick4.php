<!DOCTYPE PHP>
<head>
	<title>Douglas Quinn - Pick 4</title>
				...
				<div class="col-12">
					...
					<div class="well">
						<div class="page-header">
							<h1>VA Lottery <small>Pick 4</small></h1>
							<h4>This was created in PHP and will generate a VA Lottery, Pick 4 number.  It will then access a MYSQL database with all the Pick 4 winning lottery numbers and tell you if the number created has ever won.</h4>
						</div>
						<p class="lead">
							<?php
								$numbers = array();
								...
								$text = $text.$lotto;
								$sql = "SELECT date_hit FROM lottery_pick4 WHERE day LIKE '$lotto' OR night LIKE '$lotto'";
								echo $text;
