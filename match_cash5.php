<!DOCTYPE PHP>
<head>
	<title>Douglas Quinn - Cash 5</title>
				...
				<div class="col-12">
					...
					<div class="well">
						<div class="page-header">
							<h1>VA Lottery <small>Cash 5</small></h1>
							<h4>This was created in PHP and will generate a VA Lottery, Cash 5 number.  It will then access a MYSQL database with all the Cash 5 winning lottery numbers and tell you if the number created has ever won.</h4>
						</div>
						<p class="lead">
							<?php
								$numbers = array();
								...
								$text = $text.$lotto;
								$sql = "SELECT date_hit FROM lottery_cash5 WHERE day LIKE '$lotto' OR night LIKE '$lotto'";
								echo $text;
