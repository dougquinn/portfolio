<!DOCTYPE PHP>
<head>
	<title>Douglas Quinn - Mega Millions</title>
				...
				<div class="col-12">
					...
					<div class="well">
						<div class="page-header">
							<h1>VA Lottery <small>MegaMillions</small></h1>
							<h4>This was created in PHP and will generate a VA Lottery, Mega Millions number.  It will then access a MYSQL database with all the Mega Millions winning lottery numbers and tell you if the number created has ever won.</h4>
						</div>
						<p class="lead">
							<?php
								$numbers = array();
								...
								$ball = rand($min, $ballMax);
								$text = $text.$lotto;
								$sql = "SELECT date_hit FROM lottery_mega WHERE mega LIKE '$lotto' AND ball LIKE '$ball'";
								$text = $text."   Megaball: ".$ball;
								echo $text;
